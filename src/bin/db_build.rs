...
fn parse_stat_name(s: &str) -> Option<Stat> {
    match s {
        ...
        "CRITICAL_RATING"     => Some(Stat::CritRating),
        "DEVASTATE_RATING"    => Some(Stat::DevRating),
        "FINESSE"             => Some(Stat::FinesseRating),
        "TACTICAL_MASTERY"    => Some(Stat::TactMastery),
        "PHYSICAL_MASTERY"    => Some(Stat::PhysMastery),
        "OCMR"                => Some(Stat::OffensiveOverpower),
        "RESISTANCE"          => Some(Stat::Resistance),
        "CRITICAL_DEFENCE"    => Some(Stat::CritDefense),
        "TACTICAL_MITIGATION" => Some(Stat::TactMitigation),
        "PHYSICAL_MITIGATION" => Some(Stat::PhysMitigation),
