> **HISTORICAL — superseded.** This document records a completed implementation prompt. PR #45 is merged; retain this file for historical context only, and do not treat its tasking language as current work-in-progress guidance.
